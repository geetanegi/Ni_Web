...
import { lumenoresSaveChecklist } from "../../Api/saveChecklistApi";

const FormItem = Form.Item;
const LumenoreCheckList = () => {
  ...
  const handleSubmit = () => {
    lumenoresSaveChecklist(payloadData, fileName);
  };
  const handleRecords = () => {
      ...
      <div className="main-checklist">
        <div style={{ width: "50vw" }}>
          <div className="checklist-name">
            <span>Lumenore CheckList Details</span>
          </div>
...
export default LumenoreCheckList;
